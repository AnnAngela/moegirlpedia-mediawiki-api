import { asArray, asBoolean, asNumber, asRecord, asString, asStringArray, buildPagination, decodeContinueToken, parseDelimitedOption, parseIntegerOption, resolveTimeRange, uniqueStrings, } from "../helpers.js";
const WATCHLIST_FLAG_KEYS = ["anon", "autopatrolled", "bot", "minor", "new", "patrolled", "redirect", "unread"];
const normaliseWatchlistChange = (item) => {
...
const createPageSummary = (changes) => {
...
export const watchlistBriefOperation = {
